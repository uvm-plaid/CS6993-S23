...
(* REVIEW this is a major proof section *)
(* ################################################################# *)
...
(* This version is easier to prove correct as below *)
Fixpoint bin_to_nat (b:bin) : nat :=
  match b with
  | Z => 0
  | B0 b' => 2 * (bin_to_nat b') 
  | B1 b' => 1 + (2 * (bin_to_nat b')) (* complains about 1 + (bin_to_nat (B0 b')) *) 
  end.

Compute bin_to_nat (B1(B1(B0(B1(B0(B0(Z))))))).
...
Proof.
  intros n. simpl. rewrite add_comm. reflexivity.  Qed.
